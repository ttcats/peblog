"""
Django settings for peblog project.
...
SECRET_KEY = 'qx(al$6l5-2!^htq37_!@nsk34)zhyj-e%^iyi)cenq*h$mz8w'
...
WSGI_APPLICATION = 'peblog.wsgi.application'
